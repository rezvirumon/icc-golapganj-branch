    ...
    return (
        <div className="px-5 py-10 bg-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 container mx-auto">
                {/* Service Item 1 */}
                <div className="bg-white w-full h-72 flex flex-col items-center justify-center p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                    <FaNetworkWired className="text-6xl text-green-600 mb-4 transition-transform duration-300 transform hover:scale-110" />
                ...
                {/* Service Item 2 */}
                <div className="bg-white w-full h-72 flex flex-col items-center justify-center p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                    <FaHome className="text-6xl text-green-600 mb-4 transition-transform duration-300 transform hover:scale-110" />
                ...
                {/* Service Item 3 */}
                <div className="bg-white w-full h-72 flex flex-col items-center justify-center p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                    <FaPhone className="text-6xl text-green-600 mb-4 transition-transform duration-300 transform hover:scale-110" />
                ...
                {/* Service Item 4 */}
                <div className="bg-white w-full h-72 flex flex-col items-center justify-center p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                    <FaHeadset className="text-6xl text-green-600 mb-4 transition-transform duration-300 transform hover:scale-110" />
                ...
                {/* Service Item 5 */}
                <div className="bg-white w-full h-72 flex flex-col items-center justify-center p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                    <FaLink className="text-6xl text-green-600 mb-4 transition-transform duration-300 transform hover:scale-110" />
                ...
                {/* Service Item 6 */}
                <div className="bg-white w-full h-72 flex flex-col items-center justify-center p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                    <FaServer className="text-6xl text-green-600 mb-4 transition-transform duration-300 transform hover:scale-110" />
